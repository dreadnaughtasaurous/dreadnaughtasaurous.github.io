...
**c.** Nothing in this clause is taken to effect:
...
**(ii)** an Employee, Employer or registered organisation, pursuing matters of discrimination in any State or federal jurisdiction, including by application to the Human Rights and Equal Opportunity Commission;

**(iii)** the exemptions under the Act.
