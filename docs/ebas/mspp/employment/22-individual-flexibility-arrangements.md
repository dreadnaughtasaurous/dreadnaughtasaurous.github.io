...
topics: ['education-pd', 'leave', 'hours', 'wages', 'higher-duties']
---
...
**(iii)** provides for the arrangement to be terminated: **(A)** by either the Employee or Employer giving a specified period of written notice, with the specified period being not more than 28 days; and **(B)** at any time by written agreement between the Employee and Employer.
