...
**(c)** Performance means the manner in which the Employee fulfils their job requirements. The level of performance is determined by reference to an

Employee's knowledge, skills, qualifications, abilities and the requirements of the role.
...
**(ii)** provide the Employee with any material which forms the basis of the concerns, including statements (if any) it has at that time, before seeking a response;
...
**(C)** give the Employee a second written warning in the event that the Employee has previously been given a first written

warning within the previous 12 months for that course of Conduct;
