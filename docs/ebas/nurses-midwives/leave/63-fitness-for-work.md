...
**(a)** Where, after discussion with the Employee, the Employer continues to have a reasonable belief that the Employee is unfit to perform the duties, the Employer

may request the Employee to obtain a report from the Employee's Treating Practitioner regarding the Employee's fitness for work, provided that:
