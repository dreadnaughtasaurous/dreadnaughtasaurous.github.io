...
topics: ['fitness-for-work', 'occupational-health-and-safety', 'medical-assessment']
synonyms: ['fit for work', 'medical clearance', 'independent medical examination', 'ime', 'fitness for duty']
---
...
**86.3 Report from Treating Medical Practitioner**
...
**86.5 Information to Employee before IME**

Before the Employee attends an IME under subclause 86.4 above, the Employee will be provided with a copy of:
- **(a)** the name of the proposed IME: and
- **(b)** any correspondence (including any supporting material) proposed to be sent to the IME.

**86.6 Employee consultation and right to supplement information**
...
Nothing in this clause 86 prevents an Employer from taking any reasonable step in the workplace to ensure a safe work environment.