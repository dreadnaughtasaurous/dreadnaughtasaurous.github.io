...
- **(k)** Where the Doctor attends a medical practitioner under either subclauses 51.1(g) or (j) above, the Health Service will:
  ...
  - **(v)** reimburse the Doctor for return travel costs (see clause 40 (Travelling Allowance)) incurred for the distance between the Doctor’s ordinary place of residence and the appointment.
