...
**(a)** In order to provide support to a Doctor experiencing family violence and to provide a safe work environment to all Doctors, the Health Service will

approve any reasonable request from a Doctor experiencing family violence for:
