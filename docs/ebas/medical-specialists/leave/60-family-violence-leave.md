...
- **(b)** behaviour by a person that causes a child to hear or witness, or otherwise be exposed to the effects of, behaviour referred to in subclause (a) above.

---

**60.3 Eligibility**

- **(a)** Paid leave for family violence purposes is available to all Doctors with the exception of Internal Locum Doctors.
- **(b)** Internal Locum Doctors are entitled to access leave without pay for family violence purposes.
...
- **(c)** A Doctor experiencing family violence will be offered access to the Doctor Assistance Program (EAP) and/or other available local Doctor support resources. The EAP will include professionals trained specifically in family violence.
