...
medical specialist consultant specialist doctor VMO visiting medical officer staff specialist salaried specialist attending specialist hours of work full time doctors working hours rostering
</div>
...
- **(d)** over 40 hours in any period of seven consecutive days or 80 hours in any period of 14 consecutive days.

**28.2** A Health Service may require a Doctor to work reasonable additional hours. In determining whether additional hours are reasonable, the following must be taken into account:
...
- **(d)** whether the Doctor is entitled to receive overtime payments, penalty rates or other compensation for, or a level of remuneration that reflects an expectation of, working additional hours;
- **(e)** any notice given by the Health Service of any request or requirement to work the additional hours;
- **(f)** any notice given by the Doctor of his or her intention to refuse to work the additional hours;
- **(g)** the usual patterns of work in the industry, or the part of an industry, in which the Doctor works;
