...
DIT doctor intern resident registrar medical officer HMO RMO PHO junior doctor trainee doctor prevocational postgraduate year PGY1 PGY2 casual employment irregular no guarantee of hours engagement
</div>
...
**19.2** Subject to the minimum engagement period (or payment in lieu of), a casual Doctor’s engagement is terminable with one hour’s notice by either party. The minimum engagement for a casual Employee is two hours.

**19.3** A casual Doctor will be paid an hourly rate equal to 1/38th of the weekly salary for the Employee’s classification plus 25%.

**19.4** Except where expressly excluded, a casual Employee will be entitled to receive the allowances prescribed by this Agreement.
...
**19.6** The following provisions do not apply to casual Doctors:

- **(a)** annual leave ([clause 60](/ebas/doctors-in-training/leave/60-annual-leave));
- **(b)** paid personal/carer's leave ([clause 61](/ebas/doctors-in-training/leave/61-personal-sick-carer-s-leave));
- **(c)** paid compassionate leave ([clause 64](/ebas/doctors-in-training/leave/64-compassionate-leave));
- **(d)** paid family violence leave ([clause 71](/ebas/doctors-in-training/leave/71-family-violence-leave));
- **(e)** conference/seminar leave ([clause 50](/ebas/doctors-in-training/education-pd/50-conference-seminar-leave));
- **(f)** examination leave ([clause 49](/ebas/doctors-in-training/education-pd/49-examination-leave));
- **(g)** rosters ([clause 35](/ebas/doctors-in-training/hours-of-work/35-rosters));
- **(h)** notice period before termination ([clause 29](/ebas/doctors-in-training/doctor-employment/29-termination-of-employment));
...
- **(l)** child care costs reimbursement ([clause 57](/ebas/doctors-in-training/allowances/57-child-care-costs-reimbursement-out-of-hours-work)); and
- **(m)** community service leave (under the Act).
