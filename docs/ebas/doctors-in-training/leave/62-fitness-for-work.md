...
- **(k)** Where the Doctor attends a medical practitioner under either subclauses 62.1(g) or **(j)** above, the Health Service will:
  ...
  - **(v)** reimburse the Doctor for return travel costs (see clause 55 Travelling Allowance) incurred for the distance between the Doctors ordinary place of residence and the appointment.
