...
- **(b)** However, a Doctor may only give a notice to the Health Service under [clause 60.8(a)](/ebas/doctors-in-training/leave/60-annual-leave) if:
  ...
  - **(ii)** the Doctor has not been given a direction under [clause 60.7(a)](/ebas/doctors-in-training/leave/60-annual-leave) that, when any other paid annual leave arrangements (whether made under [clause 60.6](/ebas/doctors-in-training/leave/60-annual-leave), 60.7 or 60.8 or otherwise agreed by the Health Service and Doctor) are taken into account, would eliminate the Doctor’s excessive leave accrual.
- **(c)** A notice given by a Doctor under [clause 60.7(a)](/ebas/doctors-in-training/leave/60-annual-leave) must not:
  - **(i)** if granted, result in the employee’s remaining accrued entitlement to paid annual leave being at any time less than 6 weeks when any other paid annual leave arrangements (whether made under [clause 60.6](/ebas/doctors-in-training/leave/60-annual-leave), 60.7 or **60.8** or otherwise agreed by the Health Service and Doctor) are taken into account; or
