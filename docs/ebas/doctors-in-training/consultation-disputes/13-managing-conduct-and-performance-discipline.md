...
**(d)** Procedural Fairness means that a person whose interests will be affected by a decision receives a fair and reasonable opportunity to be heard before the decision

is made. Procedural fairness is concerned with the decision-making process followed or steps taken by a decision maker rather than the actual decision itself.
