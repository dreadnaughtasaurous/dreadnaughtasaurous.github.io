...
DIT doctor intern resident registrar medical officer HMO RMO PHO junior doctor trainee doctor prevocational postgraduate year PGY1 PGY2 rosters rostering shift schedule design rotation
</div>
...
- **(a)** A roster of at least 28 days duration that states each Doctor’s daily working hours and start and finishing times must be posted at least 28 days before the roster comes into operation.
- **(b)** The roster or rosters must be exhibited at a convenient place accessible to the Doctors to whom it applies.
...
- **(c)** The obligation to work safe hours applies to both the Health Service and Doctors.
...
- **(a)** Rosters will not change without at least fourteen days’ notice of a change in roster other than in an emergency situation external to the Employer or disaster, subject to (b), below
- **(b)** If the Health Service requires a Doctor to work ordinary hours outside of the existing roster and has not given fourteen days’ notice of the change and there is no emergency external to the Employer or disaster situation, the Doctor must be paid a daily allowance (Change of Roster Allowance) as follows:
  - **(i)** 7 days' or less notice, 5 per cent of the Doctor's ordinary weekly rate of pay for the rostered hours worked per shift; and
...
**35.8** Where Doctors swap rostered shifts, only the penalties and allowances for the shift that the Doctor actually works are payable.

**35.9 Rosters and rotation**

Where a roster (including a change of roster) will include a rotation that has not been previously agreed with the Doctor, the Health Service must seek agreement in accordance with [clause 24.3](/ebas/doctors-in-training/doctor-employment/24-rotations-between-hospitals) of this Agreement.

**35.10 Notification of a Change of Roster**

Health Services will advise Doctors as to how a change of roster will be notified to affected Doctors
