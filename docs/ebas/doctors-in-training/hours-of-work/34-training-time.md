...
DIT doctor intern resident registrar medical officer HMO RMO PHO junior doctor trainee doctor prevocational postgraduate year PGY1 PGY2 training time paid training mandatory education hours
</div>
...
- **(a)** Activities may include:
  ...
  - **(ii)** clinical meetings organised for training and education;
  - **(iii)** personal reading, study, and supervised research intended for publication;
  - **(iv)** Grand (teaching) ward rounds designed for teaching and run by an eminent medical person.
...
- **(i)** cannot be released, or  
- **(ii)** Training Time is interrupted due to emergency/disaster, or  
- **(iii)** Training Time does not occur for any reason,
