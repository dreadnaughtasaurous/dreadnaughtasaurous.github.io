...
- **(a)** 38;
- **(b)** an average of 38 per week in a two (2) or four (4) week period; or
- **(c)** by mutual agreement, an average of 38 per week in a five (5) week period in the case of an Employee working ten hour shifts.

**47.2** The hours for an ordinary week’s work will be worked either:
- **(a)** subject to [clause 48](/ebas/allied-health/hours-of-work/48-accrued-days-off) (Accrued Days Off), in 152 hours per four (4) week period worked as nineteen shifts each of eight (8) hours; or
- **(b)** by mutual agreement:
  - **(i)** in four (4) days in shifts of not more than ten hours each; or
  - **(ii)** otherwise, provided that the length of any ordinary shift will not exceed ten hours.
...
- **(b)** agrees to work broken shifts under an individual flexibility agreement ([clause 12](/ebas/allied-health/preliminary/12-individual-flexibility-arrangement)).
