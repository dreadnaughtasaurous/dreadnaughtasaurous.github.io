...
**(ii)** participating in the processes to resolve the dispute, including attending meetings, conciliation and arbitration.
...
**(i)** in the first instance by discussions between the: A. Employee/s, the Union and/or another representative; and B. the relevant supervisor/manager and/or other relevant representative of the Employer including a human resources (however described) representative, who is authorised to resolve the dispute; and
...
**(ii)** the Commission member conducting the conciliation, either on their own motion or after an application by a party, is satisfied there is no likelihood

that further conciliation will result in settlement within a reasonable period; or
