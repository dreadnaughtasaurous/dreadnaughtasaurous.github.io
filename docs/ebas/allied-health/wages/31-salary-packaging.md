...
**31.1** An Employee is entitled to salary package the current salary specified in [Appendix 2](/ebas/allied-health/appendices/2-wage-rates) in accordance with the Employer’s policy. The Employer will maintain a salary packaging policy (which may be through an external provider).
