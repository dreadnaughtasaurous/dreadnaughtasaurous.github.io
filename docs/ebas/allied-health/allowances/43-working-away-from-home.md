...
topics: ['leave', 'public-holidays', 'allowances', 'travel']
---
...
**43.2** Exception Subject to subclause 43.1, this clause 43 does not apply where an Employee voluntarily chooses for personal reasons to stay in the location prior to or after the day on which the Employee is required to work by the Employer.
