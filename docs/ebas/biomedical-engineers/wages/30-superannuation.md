...
**30.1** Definitions In this clause:
...
**30.2** Superannuation contributions The Employer will make superannuation contributions on behalf of an Employee to any of the following superannuation funds nominated by an Employee:
...
**30.3** New Employee does not nominate fund If the Employee does not nominate a fund, the Employer will pay the Employee's superannuation contributions to the Default Fund, or where required by superannuation legislation to the Employee’s stapled superannuation fund.

**30.4** Calculation of superannuation contributions Superannuation contributions paid by the Employer will be calculated and paid on:
