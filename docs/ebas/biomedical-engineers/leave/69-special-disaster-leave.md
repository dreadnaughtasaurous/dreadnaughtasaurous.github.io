...
**69.1** Special disaster leave of up to three (3) days per calendar year is payable where:

- **(a)** the Employee is a full-time or part-time Employee;
- **(b)** personal/carers leave is not available either because the Employee has exhausted the accrual or the circumstance does not qualify for personal/carers leave; and
...
**69.2** Special disaster leave is non-cumulative.
