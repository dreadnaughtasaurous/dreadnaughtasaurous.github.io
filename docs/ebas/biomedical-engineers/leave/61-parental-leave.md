...
This clause 61 is structured as follows:
...
- **(r)** Keeping in Touch Days: subclause 61.18.
...
**61.2 Definitions**  
For the purposes of this clause 61:
...
- **(a)** If:
  ...
  - **(ii)** an Employee, whether before or after the birth of the Child, gives notice in accordance with subclause 61.7 of the taking of a period of unpaid parental leave (the original leave period) in relation to the Child;  
...
- **(c)** Subclause 61.6(a) is subject to subclause 61.4, in which case the Employee taking Unpaid Parental Leave may agree with the Employer that the Employee will not take Unpaid Parental Leave during the permitted work period while the Child remains hospitalised.

- **(d) Payment**
  - **(i)** Payment for paid Parental Leave will be based on the Employee’s ordinary time rate of pay provided in Appendix 2 and will be based on the following:
...
- **(c) Taking Unpaid Parental Leave – Confirming or Changing Intended Start and End Dates**
  ...
  If any of the leave covered by the notice is Unpaid Parental Leave, at least four (4) weeks before the intended commencement of parental leave, or if that is not practicable as soon as practicable, the Eligible Employee must confirm in writing the intended start and end dates of the parental leave, or advise the Employer of any changes to the notice provided in subclause 61.7(a), unless it is not practicable to do so.
...
- **(b) Six Weeks Before the Birth**
  ...
  - **(ii)** Where a request is made under subclause 61.8(b)(i) and an Eligible Employee:
...
- **(b) Paid No Safe Job Leave**
  - **(i)** If:
    - **(A)** subclause 61.14(a) applies to a pregnant Eligible Employee but there is no appropriate safe job available;
...
- **(g) Stillbirth or Death of Child – Cancelling Leave or Returning To Work**
  ...
  - **(ii)** Where notice under subclause 61.15(g)(i) is given, the Employee's entitlement to Parental Leave in relation to the Child ends:
    - **(A)** if the action is taken under subclause 61.15(g)(i)(A), immediately after the cancellation of the leave; or
    - **(B)** if the action is taken under subclause 61.15(g)(i)(B), immediately before the specified day.
  - **(iii)** This subclause 61.15(g) does not limit subclause 61.11.

- **(h) Employee Who Ceases to Have Responsibility For Care of Child**
  - **(i)** This subclause 61.15(h) applies to an Employee who has taken unpaid Parental Leave in relation to a Child if the Employee ceases to have any responsibility for the care of the Child for a reason other than because:
...
- **(a)** Where an Eligible Employee is on parental leave and the Employer proposes a change or makes a decision that will have a significant effect within the meaning of [clause 13](/ebas/biomedical-engineers/consultation-disputes/13-consultation) (Consultation) of this Agreement on the Eligible Employee’s pre-parental leave position and/or on the status, pay or location of the Eligible Employee’s pre-parental leave position, the Employer will comply with the requirements of [clause 13](/ebas/biomedical-engineers/consultation-disputes/13-consultation) (Consultation) which include but are not limited to providing:
