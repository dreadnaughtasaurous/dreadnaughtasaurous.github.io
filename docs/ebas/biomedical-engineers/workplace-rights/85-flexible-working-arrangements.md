...
**85.2** A specified Employee is a:
...
**(i)** the Employer has: **(A)** discussed the request with the Employee; and **(B)** genuinely tried to reach an agreement with the Employee about making changes to the Employee’s working arrangements to accommodate the Employee's circumstances;
