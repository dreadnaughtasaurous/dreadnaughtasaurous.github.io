...
HAS HASMA health administrative services manager administrative worker clerical officer administration health manager patient services officer shift work shiftwork rotating shifts evening night
</div>
...
**45.2 Morning and Afternoon Shift Allowances**
...
- **(a)** The change of shift allowance set out in **Part 1** or **Part 2** of payable to Employees on the occasion of each change in the following circumstances (in addition to any amount payable under the preceding provisions of this clause):
...
- **(b) Exceptions** 
  ...
  - **(iv)** the absence of four or more weeks of continuous approved leave intervenes between the relevant shifts;
