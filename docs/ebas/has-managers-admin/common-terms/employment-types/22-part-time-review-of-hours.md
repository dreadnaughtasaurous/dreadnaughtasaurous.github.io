...
HAS HASMA health administrative services manager administrative worker clerical officer administration health manager patient services officer part-time review hours increase reduce
</div>
...
**22.4** A written response will be provided no later than 21 days from the date of a request (by either an Employee or Employer).
