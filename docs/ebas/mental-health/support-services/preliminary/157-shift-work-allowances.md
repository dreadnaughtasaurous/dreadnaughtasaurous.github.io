...
**157.3** Shift Allowances In addition to any other rates prescribed elsewhere in this Agreement, the Employee will receive the following allowances where an Employee works:
