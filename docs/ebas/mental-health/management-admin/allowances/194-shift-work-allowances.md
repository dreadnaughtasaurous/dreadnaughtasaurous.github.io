...
**194.2** Application Where a shift meets more than one definition as set out in 194.1, the Employee be paid one shift allowance only, with the higher shift allowance where the rates differ.
