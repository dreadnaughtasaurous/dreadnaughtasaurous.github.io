...
**212.2** With the exception of the Parental Leave clause DLWOP is granted at the absolute discretion of the Employer.

**212.3** DLWOP will only be considered after all other paid entitlements have been taken.

**212.4** All DLWOP must be applied for and, if appropriate, approved in advance, using the Employer’s standard leave form.
