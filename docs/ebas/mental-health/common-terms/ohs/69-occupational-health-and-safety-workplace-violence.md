...
- **(c) Definitions**
  ...
  - **(vii)** Occupational Violence Principles includes measures to:
    - **(A)** Improve security
    - **(B)** Identify risk to staff and others
    - **(C)** Include family in the development of consumer care plans
    - **(D)** Ensure violent incidents are reported, investigated and acted upon
    - **(E)** Prevent violence through workplace design
    - **(F)** Provide education and training to mental health and wellbeing staff
    - **(G)** Provide post-incident support
    - **(H)** Apply anti-violence approach across all healthcare disciplines
