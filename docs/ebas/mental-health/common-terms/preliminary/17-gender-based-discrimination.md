...
mental health worker psychiatric nurse mental health nurse community mental health AMHS authorised mental health practitioner psychosocial disability support gender based discrimination sex discrimination equal opportunity
</div>
...
**17.2** The purpose of the GBSC will be to:
- **(a)** review audit results
- **(b)** promote gender equity initiatives
- **(c)** identify and address any gender pay gaps in the public sector organisation; and
- **(d)** promote job security.

**17.3** The GBSC will schedule a minimum of four meetings per year.

**17.4** The GBSC will be comprised of:
