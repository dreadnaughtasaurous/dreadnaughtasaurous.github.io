...
Where a shift meets more than one definition as set out in 119.1, the Employee be paid one shift allowance only, with the higher shift allowance where the rates differ.

---

**119.3 Shift Allowances** 

In addition to any other rates prescribed elsewhere in this Agreement, the Employee will receive the following allowances where an Employee works:
