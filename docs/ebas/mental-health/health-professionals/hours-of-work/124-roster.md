...
---
<span data-pagefind-meta="clause:Clause 124" style="display:none"></span>
<span data-pagefind-meta="section:Hours of Work" style="display:none"></span>
<span data-pagefind-filter="eba:Mental Health Services 2024-2028" style="display:none"></span>

<div class="pagefind-synonyms" style="display:none" aria-hidden="true">
mental health worker psychiatric nurse mental health nurse community mental health AMHS authorised mental health practitioner psychosocial disability support roster rostering shift rotation working schedule
</div>
...
- **(b) Roster Requirements** 
  Rosters will:
  - **(i)** Set out: 
    - **(A)** The Employee's ordinary working hours 
    - **(B)** Starting and finishing times 
    - **(C)** Meal intervals.
  - **(ii)** Provide an Employee who works 0.8 EFT or more with two consecutive days off per week. Nothing in this subclause (b) is intended to: 
    - **(A)** Restrict an Employee requesting single days off, including as a self- rostering request; or 
    - **(B)** Prevent an Employee who works 0.8 EFT or more from having a single day off rostered where they also have consecutive days off rostered that week.
